...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> sRawTextFeedIds = this.getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
                        
		// TODO: Start the DownloaderTask 
		downloader.execute(sRawTextFeedIds.toArray(new Integer[sRawTextFeedIds.size()]));
	}
