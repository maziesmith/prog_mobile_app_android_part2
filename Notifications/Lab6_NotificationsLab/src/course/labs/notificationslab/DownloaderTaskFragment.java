...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		downloader.execute(ids.toArray(new Integer[ids.size()]));
	}
							...
							if (MainActivity.IS_ALIVE != getResultCode()) {
								...
								PendingIntent restart = 
										PendingIntent.getActivity(
												context, 0, restartMainActivityIntent, 
								...
								notification_manager.notify(MY_NOTIFICATION_ID, notificationBuilder.build());
